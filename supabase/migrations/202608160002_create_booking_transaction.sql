...
begin
  ...
  loop
    v_extra_total := ((v_extra ->> 'quantity')::int * (v_extra ->> 'unitPrice')::numeric(10,2));
  ...
  loop
    ...
    values (
      ...
      v_extra ->> 'key',
      v_extra ->> 'label',
      (v_extra ->> 'quantity')::int,
      (v_extra ->> 'unitPrice')::numeric(10,2),
      ((v_extra ->> 'quantity')::int * (v_extra ->> 'unitPrice')::numeric(10,2))
    );
  end loop;
