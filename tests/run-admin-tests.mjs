...
try {
  ...
  const testFiles = ['tests/admin-dashboard.test.mjs', 'tests/admin-dashboard-kpis.test.mjs', 'tests/admin-confirm-booking.test.mjs', 'tests/admin-list-service.test.mjs', 'tests/admin-pagination.test.mjs', 'tests/admin-reservations-export.test.mjs', 'tests/admin-critical-flows.test.mjs', 'tests/booking-payment-method-key.test.mjs', 'tests/admin-security-hardening.test.mjs', 'tests/admin-management-rules.test.mjs', 'tests/admin-drafts-and-reorder.test.mjs', 'tests/admin-tour-wizard.test.mjs', 'tests/admin-boat-packages.test.mjs', 'tests/admin-content-translation.test.mjs', 'tests/translation-public.test.mjs', 'tests/admin-to-landing.test.mjs', 'tests/public-boats-translation.test.mjs', 'tests/package-included-public.test.mjs', 'tests/public-catalog-order.test.mjs', 'tests/i18n-static-content.test.mjs', 'tests/paypal-checkout-lifecycle.test.mjs'];
